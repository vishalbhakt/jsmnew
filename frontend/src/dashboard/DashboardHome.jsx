...
import { dashboardStats, performanceData } from "../utils/fixtures";
...
export default function DashboardHome() {
  ...
  const stats = dashboardStats[role] || dashboardStats.student;
        ...
        <section className="panel p-5">
          ...
          <div className="h-72">
            <ResponsiveContainer width="100%" height="100%">
              <AreaChart data={performanceData} margin={{ top: 8, right: 12, left: -18, bottom: 0 }}>
                <defs>
        ...
        <section className="panel p-5">
          ...
          <div className="mt-4 grid gap-3">
            {[
              ...
              ["Assignment", "Linear Equations Practice due this week"],
              ["Announcement", "Admissions open for 2026-27"],
              ["Payment", "Term 1 fee plan active"],
            ].map(([label, value]) => (
